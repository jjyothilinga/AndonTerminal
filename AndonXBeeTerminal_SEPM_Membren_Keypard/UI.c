...
const rom UINT8 keyMap[MAX_KEYS + 1][MAX_CHAR_PER_KEY] = {{0xFF,0xFF,0xFF,0xFF},
													{'1','1','1','1'},{'2','A','B','C'},{'3','D','E','F'},{'\x0B','\x0B','\x0B','\x0B'},
													{'4','G','H','I'},{'5','J','K','L'},{'6','M','N','O'},{'\x0C','\x0C','\x0C','\x0C'},
													{'7','P','R','S'},{'8','T','U','V'},{'9','W','X','Y'},{'\x08','\x08','\x08','\x08'},

													{'*','*','*','*'},{'0','Q','Z','-'},{'\x13','\x13','\x13','\x13'},{'\x0A','\x0A','\x0A','\x0A'}
