...
#define	KBD_COL3				PORTBbits.RB2
#define	KBD_COL3_DIR			TRISBbits.TRISB2	
#define	KBD_COL2				PORTBbits.RB2	
#define	KBD_COL2_DIR			TRISBbits.TRISB2	
#define	KBD_COL1				PORTBbits.RB2	
#define	KBD_COL1_DIR			TRISBbits.TRISB2	
#define	KBD_COL0				PORTBbits.RB2
#define	KBD_COL0_DIR			TRISBbits.TRISB2
...
#define	KBD_ROW2				PORTBbits.RB2	
#define	KBD_ROW2_DIR			TRISBbits.TRISB2	
#define	KBD_ROW3				PORTBbits.RB2
#define	KBD_ROW3_DIR			TRISBbits.TRISB2
...
// Buzzer O/P
#define	BUZ_OP					LATAbits.LATA0
#define	BUZ_OP_DIR				TRISAbits.TRISA0	
