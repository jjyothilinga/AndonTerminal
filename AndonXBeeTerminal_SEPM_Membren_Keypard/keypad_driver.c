	...
	if(currentKey == KEYPAD_NO_NEW_DATA)
	{
	   	KBD_COL1 = 0; // Scanning column 1
	    	...
	    	if (KBD_ROW1 == 0) currentKey = 0x5;
	      	if (KBD_ROW2 == 0) currentKey = 0x9;
	      	if (KBD_ROW3 == 0) currentKey = 0xd;
	   	KBD_COL1 = 1;
	}
	if(currentKey == KEYPAD_NO_NEW_DATA)
	{
	   	KBD_COL2 = 0; // Scanning column 2
	    	if (KBD_ROW0 == 0) currentKey = 0x2;
	      	...
	      	if (KBD_ROW2 == 0) currentKey = 0xa;
	      	if (KBD_ROW3 == 0) currentKey = 0xe;
	   	KBD_COL2 = 1;
	}
	...
	if(currentKey == KEYPAD_NO_NEW_DATA)
	{
		KBD_COL3 = 0; // Scanning column 3
	    	if (KBD_ROW0 == 0) currentKey = 0x3;
	      	if (KBD_ROW1 == 0) currentKey = 0x7;
	      	if (KBD_ROW2 == 0) currentKey = 0xb;
	      	if (KBD_ROW3 == 0) currentKey = 0xf;
	   	KBD_COL3 = 1;
	}
