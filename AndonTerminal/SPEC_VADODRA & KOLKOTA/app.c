...
void APP_getOpenIssue(far OpenIssue *openIssue)
{
	...
	for(l=0; l < MAX_ISSUES; l++,i++)
	{
		...
		switch( ias.issues[i].data[k] )
		{
			...
			case '1': 
				openIssue->tag[j++] = 'M';openIssue->tag[j++] = 'A';openIssue->tag[j++] = 'I';openIssue->tag[j++] = 'N';openIssue->tag[j++] = 'T';openIssue->tag[j++] = 'E';
				openIssue->tag[j++]= 'N';openIssue->tag[j++]= 'A';openIssue->tag[j++]= 'N';openIssue->tag[j++]= 'C';openIssue->tag[j++]= 'E';openIssue->tag[j++]= ';';
			
				break;
			case '2': 
				openIssue->tag[j++] = 'I';openIssue->tag[j++] = 'N';openIssue->tag[j++] = 'D';openIssue->tag[j++] = 'U';openIssue->tag[j++] = 'S';openIssue->tag[j++] = 'T';
				openIssue->tag[j++] = 'R';openIssue->tag[j++] = 'I';openIssue->tag[j++] = 'A';openIssue->tag[j++]= 'L';openIssue->tag[j++]= ';';
			...
			case '5': 
				openIssue->tag[j++] = 'S';openIssue->tag[j++] = 'U';openIssue->tag[j++] = 'P';openIssue->tag[j++] = 'E';openIssue->tag[j++] = 'R';openIssue->tag[j++] = 'V';
				openIssue->tag[j++] = 'I';openIssue->tag[j++] = 'S';openIssue->tag[j++] = 'O';openIssue->tag[j++] = 'R';openIssue->tag[j++]= ';';
		...
		for(i = 0; i< MAX_ISSUES ; i++)
		{
			...
			if(  issueIndex != -1)
			{
				...
				
				{
					...
					{
					//	ias.state = ISSUE_RESOLVED;
						updateIndication(0,1,1,0);  			// change it
					}
					else
					{
						//ias.state = ISSUE_RAISED;
